...
//		dragaoAladoDeRa.setCard("Dragão Alado de Rá", 10, divino, bestaDivina, efeitoContinuo, 0, 9999, 9999, descricao);
...
//		descricao = "";
//		cardMonstro.setCard("Palhaço Cruel", 4, "Dark", tipo, numero, 1350, 1400, descricao);
...
//		descricao = "";
//		cardMonstroComEfeito.setCard("Sábio Negro", 9, "Trevas", tipo, numero, 2800, 3200, descricao);
//		deck.add(cardMonstroComEfeito);
		
//		descricao = "";
//		cardMonstro.setCard("Slifer, o Dragão do Céu", 10, "Divino", tipo, numero, 9999, 9999, descricao);
//		deck.add(cardMonstro);
...
//		descricao = "VIRE: Você pode escolher até 2 monstros no campo; devolva esses alvos para a mão.";
//		cardMonstroComEfeito.setCard("Soldado Pinguim", 2, "Água", , numero, 750, 500, descricao);
//		deck.add(cardMonstroComEfeito);
...
//		descricao = "";
//		cardMonstroComEfeito.setCard("Dragão Alado de Rá", 10, "Terra", tipo, numero, 9999, 9999, descricao);
//		deck.add(cardMonstroComEfeito);
